...
| [`.devcontainer/Dockerfile`](../../.devcontainer/Dockerfile) | Base image (`mcr.microsoft.com/devcontainers/python:3.11-bookworm`) plus minimal patches (currently removes the expired Yarn apt repo). |
