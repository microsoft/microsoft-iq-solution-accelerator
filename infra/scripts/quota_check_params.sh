...
DEFAULT_MODEL_CAPACITY="gpt-5-mini:150"
...
DEFAULT_REGIONS="australiaeast,japaneast,eastus,uksouth,eastus2,northcentralus,swedencentral,westus,southcentralus"
